...
urlpatterns = [
    ...
    path('edit_post/<uuid:user_id>/<int:edit_post_id>/', views.edit_post, name = 'edit_post'),
    path('show_post/<uuid:user_id>/<int:show_post_id>/', views.show_post, name = 'show_post'),
